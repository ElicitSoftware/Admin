...
--message_templates
INSERT INTO survey.message_templates(id, department_id, message_type_id, subject, message, cron_schedule) VALUES(NEXTVAL('survey.message_templates_seq'), 1, 1, 'Family History Request from Testing Department (Dev)','Hello,<br>You are receiving this notice because you have an upcoming appointment in the Test Department office.<br><br>Our practice, in collaboration with the Michigan Oncology Quality Consortium (MOQC) and the University of Michigan, is testing a new way for patients to easily share their family history with their healthcare team. This no-cost MiGHT Family Cancer History Tool is designed to help you gather information about your family history of cancer.<br>
