...
/**
 * What is running: name, version, build time, active profiles and uptime (UC-020 step 2).
 * <p>
 ...
 * a build that skips filtering leaves them unset and the screen shows "unknown" (UC-020 A3).
 */
@Startup
@ApplicationScoped
