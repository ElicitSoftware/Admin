 ...
 * It uses the new Vaadin 25 @StyleSheet approach to load the application theme.
 * <p>
 ...
 * <p>
 * Key Features:
 * - Theme Configuration: Loads Aura theme and custom styles from META-INF/resources
 ...
 * <p>
 * Note: The context:// protocol is required for custom URL mappings (e.g., vaadin.url-mapping).
 */
...
public class AppConfig implements AppShellConfigurator {
    ...
    static java.util.Map<String, String> localizedBrandText(String json, java.util.Locale locale) {
        ...
        try {
            ...
            io.quarkus.logging.Log.debug("No localized brand text available", e);
        }
        return result;
    }
        ...
        if (brandPath != null) {
            ...
            try {
                ...
                if (metadataFile != null) {
                    ...
                    String description = localized.getOrDefault("description", extractJsonValue(content, "description"));
