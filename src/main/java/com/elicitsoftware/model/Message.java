...
public class Message extends PanacheEntityBase {
    ...
    /**
     * Compares this message to another based on primary key equality.
     * <p>
     * {@code id} is a boxed, nullable {@code Long} (unset before the entity is persisted),
     * so comparison and hashing use {@link java.util.Objects} null-safe helpers.
     *
     * @param o the object to compare with
     * @return {@code true} if the other object is a {@code Message} with the same id
     */
    @Override
